...
> [!NOTE]
> - **Price**: This plugin requires a paid Mistral AI account (at the time of writing, it costs $2 per 1000 pages processed).
> - **Privacy**: Attachments are sent to Mistral's OCR service for text extraction. You should check out the [Mistral Privacy Policy](https://legal.mistral.ai/terms/privacy-policy), and also establish what way, if any, they use the text that they have extracted from your PDFs.
> - **Future development**: A free, local option will be added in an upcoming release.
